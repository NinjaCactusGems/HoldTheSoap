...
- A "Buy me a coffee" pill (`CoffeeLink` in `Game.tsx`) shows for eliminated players from elimination through the winner screen, and disappears when the post-game lobby slides in. Winners never see it.
